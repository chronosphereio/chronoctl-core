...
type ConsumptionConfig struct {
	...
	Spec           *models.ConfigunstableConsumptionConfig `json:"spec"`
}

func NewConsumptionConfig(spec *models.ConfigunstableConsumptionConfig) *ConsumptionConfig {
...
func CreateConsumptionConfig(
	...
	res, err := client.CreateConsumptionConfig(&config_unstable.CreateConsumptionConfigParams{
		Context: ctx,
...
func GetConsumptionConfig(
	...
	res, err := client.ReadConsumptionConfig(&config_unstable.ReadConsumptionConfigParams{
		Context: ctx,
	})
	if err != nil {
		return nil, clienterror.Wrap(err)
...
func UpdateConsumptionConfig(
	...
	res, err := client.UpdateConsumptionConfig(&config_unstable.UpdateConsumptionConfigParams{
		Context: ctx,
...
func DeleteConsumptionConfig(
	...
	_, err := client.DeleteConsumptionConfig(&config_unstable.DeleteConsumptionConfigParams{
		Context: ctx,
	})
	if err != nil {
...
func newConsumptionConfigDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			res, err := client.DeleteConsumptionConfig(&config_unstable.DeleteConsumptionConfigParams{
				Context: ctx,
			})
			if err != nil {
				return clienterror.Wrap(err)
