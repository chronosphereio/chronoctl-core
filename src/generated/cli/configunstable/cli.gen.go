...
func ApplyMappings() map[types.TypeMeta]func(context.Context, client.Clients, types.Object, bool) error {
	return map[types.TypeMeta]func(context.Context, client.Clients, types.Object, bool) error{
		...
		NotebookTypeMeta: func(ctx context.Context, clients client.Clients, obj types.Object, dryRun bool) error {
			entity, ok := obj.(*Notebook)
			if !ok {
				return types.WrongObjectErr((&Notebook{}), obj)
			}
			...
			_, err := UpdateNotebook(ctx, clients.ConfigUnstable, entity, updateOpts)
			if err != nil {
				return err
			}
			return nil
