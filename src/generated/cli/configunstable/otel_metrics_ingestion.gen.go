...
func CreateOtelMetricsIngestion(
	...
	res, err := client.CreateOtelMetricsIngestion(&config_unstable.CreateOtelMetricsIngestionParams{
		Context: ctx,
...
func GetOtelMetricsIngestion(
	...
	res, err := client.ReadOtelMetricsIngestion(&config_unstable.ReadOtelMetricsIngestionParams{
		Context: ctx,
	})
	if err != nil {
		return nil, clienterror.Wrap(err)
...
func UpdateOtelMetricsIngestion(
	...
	res, err := client.UpdateOtelMetricsIngestion(&config_unstable.UpdateOtelMetricsIngestionParams{
		Context: ctx,
...
func DeleteOtelMetricsIngestion(
	...
	_, err := client.DeleteOtelMetricsIngestion(&config_unstable.DeleteOtelMetricsIngestionParams{
		Context: ctx,
	})
	if err != nil {
...
func newOtelMetricsIngestionDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			res, err := client.DeleteOtelMetricsIngestion(&config_unstable.DeleteOtelMetricsIngestionParams{
				Context: ctx,
			})
			if err != nil {
				return clienterror.Wrap(err)
...
const OtelMetricsIngestionScaffoldYAML = `api_version: unstable/config
kind: OtelMetricsIngestion
spec:
    resource_attributes:
