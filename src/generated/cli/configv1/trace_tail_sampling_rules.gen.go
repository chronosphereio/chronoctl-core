...
func CreateTraceTailSamplingRules(
	...
	res, err := client.CreateTraceTailSamplingRules(&config_v1.CreateTraceTailSamplingRulesParams{
		Context: ctx,
...
func GetTraceTailSamplingRules(
	...
	res, err := client.ReadTraceTailSamplingRules(&config_v1.ReadTraceTailSamplingRulesParams{
		Context: ctx,
	})
	if err != nil {
		return nil, clienterror.Wrap(err)
...
func UpdateTraceTailSamplingRules(
	...
	res, err := client.UpdateTraceTailSamplingRules(&config_v1.UpdateTraceTailSamplingRulesParams{
		Context: ctx,
...
func DeleteTraceTailSamplingRules(
	...
	_, err := client.DeleteTraceTailSamplingRules(&config_v1.DeleteTraceTailSamplingRulesParams{
		Context: ctx,
	})
	if err != nil {
...
func newTraceTailSamplingRulesDeleteCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			res, err := client.DeleteTraceTailSamplingRules(&config_v1.DeleteTraceTailSamplingRulesParams{
				Context: ctx,
			})
			if err != nil {
				return clienterror.Wrap(err)
