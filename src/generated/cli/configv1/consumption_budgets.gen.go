...
spec:
    ...
    thresholds:
        - action: <ALERT_WARN|ALERT_CRITICAL|DROP>
          ...
          resource_group: <LOG_PERSISTED_BYTES|LOG_PROCESSED_BYTES|METRIC_PERSISTED_SERIES|METRIC_ALL|LOG_ALL|TRACE_PROCESSED_BYTES|TRACE_PERSISTED_BYTES|TRACE_ALL>
          type: <DAILY_VOLUME|INSTANT_RATE|WEEKLY_VOLUME|MONTHLY_VOLUME|HOURLY_VOLUME|ROLLING_1_HOUR_VOLUME|ROLLING_3_HOUR_VOLUME|ROLLING_1_DAY_VOLUME|ROLLING_7_DAY_VOLUME|ROLLING_30_MINUTE_VOLUME>
          unit: <NATIVE|CREDITS>
          volume:
    ...
    resource: <LOG_PERSISTED_BYTES|LOG_PROCESSED_BYTES|METRIC_PERSISTED_SERIES|METRIC_ALL|LOG_ALL|TRACE_PROCESSED_BYTES|TRACE_PERSISTED_BYTES|TRACE_ALL>
`
