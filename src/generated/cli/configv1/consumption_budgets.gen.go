...
spec:
    ...
    thresholds:
        - action: <ALERT_WARN|ALERT_CRITICAL|DROP>
          ...
          resource_group: <LOG_PERSISTED_BYTES|LOG_PROCESSED_BYTES|METRIC_PERSISTED_SERIES|METRIC_ALL|LOG_ALL>
    ...
    resource: <LOG_PERSISTED_BYTES|LOG_PROCESSED_BYTES|METRIC_PERSISTED_SERIES|METRIC_ALL|LOG_ALL>
`
