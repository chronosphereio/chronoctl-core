...
spec:
    ...
    # Labels to include in notifications generated by this monitor, and can be used to
    # route alerts with notification overrides.
    labels:
        key_1: <string>
    ...
    annotations:
        key_1: <string>
    # Optional. Specifies the notification policy used to route alerts generated by
    # the monitor. If omitted, the notification policy is inherited from the monitor.
    notification_policy_slug: <string>
    # Optional. Determines how often alerts are evaluated. Default: '60s'.
