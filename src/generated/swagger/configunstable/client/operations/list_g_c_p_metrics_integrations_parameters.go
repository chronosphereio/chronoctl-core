...
ListGCPMetricsIntegrationsParams contains all the parameters to send to the API endpoint
	...
	for the list g c p metrics integrations operation.
...
// WithDefaults hydrates default values in the list g c p metrics integrations params (not the query body).
//
...
// SetDefaults hydrates default values in the list g c p metrics integrations params (not the query body).
//
// All values with no default are reset to their zero value.
...
// SetPageMaxSize adds the pageMaxSize to the list g c p metrics integrations params
func (o *ListGCPMetricsIntegrationsParams) SetPageMaxSize(pageMaxSize *int64) {
	o.PageMaxSize = pageMaxSize
}

// WithPageToken adds the pageToken to the list g c p metrics integrations params
func (o *ListGCPMetricsIntegrationsParams) WithPageToken(pageToken *string) *ListGCPMetricsIntegrationsParams {
	o.SetPageToken(pageToken)
	return o
}

// SetPageToken adds the pageToken to the list g c p metrics integrations params
func (o *ListGCPMetricsIntegrationsParams) SetPageToken(pageToken *string) {
	o.PageToken = pageToken
}

// WithSlugs adds the slugs to the list g c p metrics integrations params
func (o *ListGCPMetricsIntegrationsParams) WithSlugs(slugs []string) *ListGCPMetricsIntegrationsParams {
	o.SetSlugs(slugs)
	return o
}

// SetSlugs adds the slugs to the list g c p metrics integrations params
