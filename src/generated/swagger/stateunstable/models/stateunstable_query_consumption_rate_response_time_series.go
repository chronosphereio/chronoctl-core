...
func (m *StateunstableQueryConsumptionRateResponseTimeSeries) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StateunstableQueryConsumptionRateResponseTimeSeries) validateDatapoints(formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRateResponseTimeSeries) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StateunstableQueryConsumptionRateResponseTimeSeries) contextValidateDatapoints(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRateResponseTimeSeries) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StateunstableQueryConsumptionRateResponseTimeSeries) UnmarshalBinary(b []byte) error {
	var res StateunstableQueryConsumptionRateResponseTimeSeries
