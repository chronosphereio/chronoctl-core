...
// Validate validates this stateunstable query consumption request
func (m *StateunstableQueryConsumptionRequest) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateCumulativePeriodStartAt(formats); err != nil {
		res = append(res, err)
	}
...
func (m *StateunstableQueryConsumptionRequest) validateResource(formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRequest) validateStartAt(formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRequest) validateEndAt(formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRequest) validateCumulativePeriodStartAt(formats strfmt.Registry) error {
	if swag.IsZero(m.CumulativePeriodStartAt) { // not required
		return nil
	}

	if err := validate.FormatOf("cumulative_period_start_at", "body", "date-time", m.CumulativePeriodStartAt.String(), formats); err != nil {
		return err
	}
...
func (m *StateunstableQueryConsumptionRequest) validateDatasetFilters(formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRequest) validatePage(formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRequest) contextValidateResource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRequest) contextValidateDatasetFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRequest) contextValidatePage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRequest) UnmarshalBinary(b []byte) error {
	var res StateunstableQueryConsumptionRequest
