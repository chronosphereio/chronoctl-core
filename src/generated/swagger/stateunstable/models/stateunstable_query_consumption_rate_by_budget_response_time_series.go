...
func (m *StateunstableQueryConsumptionRateByBudgetResponseTimeSeries) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StateunstableQueryConsumptionRateByBudgetResponseTimeSeries) validateDatapoints(formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRateByBudgetResponseTimeSeries) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StateunstableQueryConsumptionRateByBudgetResponseTimeSeries) contextValidateDatapoints(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRateByBudgetResponseTimeSeries) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StateunstableQueryConsumptionRateByBudgetResponseTimeSeries) UnmarshalBinary(b []byte) error {
	var res StateunstableQueryConsumptionRateByBudgetResponseTimeSeries
