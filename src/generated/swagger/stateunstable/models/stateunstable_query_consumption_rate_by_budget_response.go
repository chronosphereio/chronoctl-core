...
func (m *StateunstableQueryConsumptionRateByBudgetResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *StateunstableQueryConsumptionRateByBudgetResponse) validateSeries(formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRateByBudgetResponse) validatePage(formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRateByBudgetResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *StateunstableQueryConsumptionRateByBudgetResponse) contextValidateSeries(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRateByBudgetResponse) contextValidatePage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StateunstableQueryConsumptionRateByBudgetResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StateunstableQueryConsumptionRateByBudgetResponse) UnmarshalBinary(b []byte) error {
	var res StateunstableQueryConsumptionRateByBudgetResponse
