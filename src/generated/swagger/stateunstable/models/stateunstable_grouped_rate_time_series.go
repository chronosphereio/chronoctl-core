...
// Validate validates this stateunstable grouped rate time series
...
func (m *StateunstableGroupedRateTimeSeries) validateGroupKey(formats strfmt.Registry) error {
...
func (m *StateunstableGroupedRateTimeSeries) validateDatapoints(formats strfmt.Registry) error {
...
func (m *StateunstableGroupedRateTimeSeries) contextValidateGroupKey(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StateunstableGroupedRateTimeSeries) contextValidateDatapoints(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StateunstableGroupedRateTimeSeries) UnmarshalBinary(b []byte) error {
	var res StateunstableGroupedRateTimeSeries
