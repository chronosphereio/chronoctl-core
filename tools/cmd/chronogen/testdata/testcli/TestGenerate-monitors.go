...
spec:
    ...
    # Optional schedule for when the monitor should be evaluated. If not set, then
    # the monitor defaults to being always active.
    schedule:
        # The timezone of the time ranges.
        timezone: <string>
        # Days which the monitor is active during. If any day is not set, then the
        # monitor will not be active at all on said day.
        weekly_schedule:
            friday:
                # Required enum for when the monitor is active on this day. If ALL_DAY,
            ...
            wednesday:
                ...
                ranges:
                    - # End time in the in format "<hour>:<minute>", e.g. "15:30".
                      ...
                      # Start time in the in format "<hour>:<minute>", e.g. "15:30".
                      start_hh_mm: <string>
    # Conditions to determine the severity of each series.
    ...
    series_conditions:
        ...
        defaults:
            critical:
                ...
                conditions:
                    - # How the metric value and the configured value are compared.
                      op: <GEQ|GT|LEQ|LT|EQ|NEQ|EXISTS|NOT_EXISTS>
                      # How long op operation needs to evaluate to true for the condition to evaluate to true.
            ...
            - # Set of matchers on a series' labels.
              ...
              label_matchers:
                - # name always matches against an exact label name.
                  ...
                  value: <string>
              # Mapping of alert severity to its conditions for series that match this
                ...
                warn:
                    ...
                    conditions:
                        - # How the metric value and the configured value are compared.
                          ...
                          # The value to compare to the metric value using the op operation.
                          value: <number>
    # Optional grouping of series into signals. If this is omitted, all series will group together into one signal.
    signal_grouping:
